...
class Bert_BiLSTM_CRF(nn.Module):
    ...
    def __init__(self, model_name_or_path, tag_to_ix, embedding_dim=768, hidden_dim=256):
        ...
        if "bert" in model_name_or_path:
            ...
            self.bert = BartModel.from_pretrained(model_name_or_path)  
        else:
            raise NotImplementedError
        # self.bert = BartModel.from_pretrained("fnlp/bart-base-chinese") # bart-chinese
